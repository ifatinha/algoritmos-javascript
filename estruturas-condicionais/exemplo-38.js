...
console.log("Valor Investido".padEnd(50, ".") + ": R$" + valorInvestir.toFixed(2));
console.log("Rendimento Mensal".padEnd(50, ".") + ": R$" + rendimentoMensal.toFixed(2));
console.log("Valor atualizado".padEnd(50, ".") + ": R$" + valorFinal.toFixed(2));