...
if (posicao !== -1) {
    console.log(`A posição da última aparição da letra ${letra} na frase digitada é ${posicao}`);
} else {
    console.log(`A letra  "${posicao}" não aparece nenhuma vez na frase digitada.`);
}