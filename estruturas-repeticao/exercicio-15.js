...
for (let i = 1; i <= 10; i++) {
    let sexo = scanner.question("Sexo do Participante (M - Masculino; F - Feminino): ");

    while (sexo !== "M" && sexo !== "m" && sexo !== "F" && sexo !== "f") {
        sexo = scanner.question("Opção inválida! Escolha uma das opções (M - Masculino; F - Feminino): ");
    }
...
console.log("O percentual de mulheres que responderam SIM foi de " + percMulheres + "%");
console.log("O percentual de homens que responderam NÃO foi de " + percHomens + "%");