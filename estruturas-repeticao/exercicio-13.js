...
if (faixaEtaria1 > 0) {
    ...
    console.log("Média de peso das pessoas das pessoas com idade entre 01 e 10 anos: " + media1.toFixed(2));
} else {
...
if (faixaEtaria2 > 0) {
    ...
    console.log("Média de peso das pessoas das pessoas com idade entre 11 e 20 anos: " + media2.toFixed(2));
} else {
...
if (faixaEtaria3 > 0) {
    ...
    console.log("Média de peso das pessoas das pessoas com idade entre 21 e 30 anos: " + media3.toFixed(2));
} else {
...
if (faixaEtaria4 > 0) {
    ...
    console.log("Média de peso das pessoas das pessoas com idade acima de 30 anos: " + media4.toFixed(2));
} else {
