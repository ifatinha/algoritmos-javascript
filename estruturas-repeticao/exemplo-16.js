...
while (base <= 0) {
    base = scanner.questionFloat("Valor Invalido! Informe um valor maior que 0: ");
}

let altura = scanner.questionFloat("Informe o valor da altura: ");

while (altura <= 0) {
    altura = scanner.questionFloat("Valor Invalido! Informe um valor maior que 0: ");
}

let area = (base * altura) / 2;

console.log("Valor da area de um triangulo com base " + base + " e altura " + altura + " = " + area.toFixed(2));