...
do {
    ...
    if (numCanal !== 0) {
        while (numCanal !== 12 && numCanal !== 7 && numCanal !== 5 && numCanal !== 4) {
            console.log("Número do Canal");
            console.log("12 - Globo");
            console.log("7 - SBT");
            console.log("5 - Bandeirantes");
        ...
        while (tvLigada !== 1 && tvLigada !== 2) {
            tvLigada = scanner.questionInt("Opção Inválida! A TV está ligada (1 - Sim; 2 - Não): ");
        }

        if (tvLigada === 1) {

            let numPessoas = scanner.questionInt("Número de Pessoas que estavam assistindo: ");
            qtdUsuarios++;
...
if (qtdCanal12 === 0) {
    ...
    console.log("A quantidade de pessoas que estavam assistindo ao canal 12 foi de " + qtdCanal12 +
        " pessoas. O que equivale a " + porcentagem + "% de audiências.");
}
...
if (qtdCanal7 === 0) {
    ...
    console.log("A quantidade de pessoas que estavam assistindo ao canal 12 foi de " + qtdCanal7 +
        " pessoas. O que equivale a " + porcentagem + "% de audiências.");
}
...
if (qtdCanal5 === 0) {
    ...
    console.log("A quantidade de pessoas que estavam assistindo ao canal 12 foi de " + qtdCanal5 +
        " pessoas. O que equivale a " + porcentagem + "% de audiências.");
}
...
if (qtdCanal4 === 0) {
    ...
    console.log("A quantidade de pessoas que estavam assistindo ao canal 12 foi de " + qtdCanal4 +
        " pessoas. O que equivale a " + porcentagem + "% de audiências.");
}