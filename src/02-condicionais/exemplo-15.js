...
let salarioMinino = scanner.questionFloat(
  "Informe o valor do salario minimo: "
);
let qtdHorasTrabalhadas = scanner.questionInt(
...
console.log(
  "Valor da hora trabalhada".padEnd(50, ".") + ": R$" + valorHoraTrabalhada
);
console.log("Valor horas extras".padEnd(50, ".") + ": R$" + valorHorasExtras);
console.log(
  "Quantidade de dependentes".padEnd(50, ".") + ": " + numDependentes
);
console.log(
  "Quantidade de horas trabalhadas".padEnd(50, ".") + ": " + qtdHorasTrabalhadas
);
console.log(
  "Quantidade de Horas extras".padEnd(50, ".") + ": " + qtdHorasExtras
);
console.log("Sálario do Mês".padEnd(50, ".") + ": +R$" + salarioMes);
console.log(
  "Horas extras trabalhadas".padEnd(50, ".") + ": +R$" + totalHorasExtras
);
