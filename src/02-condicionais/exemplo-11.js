...
horaInicio.setMinutes(
  scanner.questionInt("Informe os minutos de inicio do jogo: ")
);

horaTermino.setHours(
  scanner.questionInt("Informe a hora de termino do jogo: ")
);
horaTermino.setMinutes(
  scanner.questionInt("Informe os minutos de termino do jogo: ")
);
...
console.log(
  "O Jogo durou " + horaDuracao + " horas e " + minutoDuracao + " minutos"
);
