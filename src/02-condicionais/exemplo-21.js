...
let codEstado = scanner.questionInt(
  "Codigo do estado de origem da carga (1 - 5): "
);
...
if (codEstado <= 0 || codEstado > 5) {
  ...
  if (codCarga < 10 || codCarga > 40) {
    ...
    console.log(
      "Peso da Carga em Toneladas: ".padEnd(50, ".") + ": " + pesoToneladas
    );
    console.log(
      "Peso da Carga em Quilos: ".padEnd(50, ".") + ": " + pesoQuilos
    );
    ...
    console.log(
      "Valor do Imposto sobre a carga: ".padEnd(50, ".") + ": R$" + valorImposto
    );
