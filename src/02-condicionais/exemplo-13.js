...
switch (opcao) {
  ...
  case 2:
    ...
    if (salario > 1500) {
      console.log("Valor do aumento".padEnd(20, ".") + ": R$" + 25.0);
      novoSalario = salario + 25;
    } else if (salario > 750 && salario <= 1500) {
      console.log("Valor do aumento".padEnd(20, ".") + ": R$" + 50.0);
      novoSalario = salario + 50;
    } else if (salario > 450 && salario < 750) {
      console.log("Valor do aumento".padEnd(20, ".") + ": R$" + 75.0);
      novoSalario = salario + 75;
    } else {
      console.log("Valor do aumento".padEnd(20, ".") + ": R$" + 100.0);
      novoSalario = salario + 100;
    }

    console.log(
      "Novo Sálario".padEnd(20, ".") + ": R$" + novoSalario.toFixed(2)
    );
    break;
