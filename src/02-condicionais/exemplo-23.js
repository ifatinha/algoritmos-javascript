...
let turnoTrabalho = scanner.question(
...
console.log(
  "Quantidade de horas trabalhadas".padEnd(50, ".") + ": R$ " + qtdHorasTrab
);
console.log(
  "Coeficiente de Sálario".padEnd(50, ".") +
    ": " +
    coeficienteTrab.toFixed(2) +
    "%"
);
console.log(
  "Sálario Bruto".padEnd(50, ".") + ": +R$ " + salarioBruto.toFixed(2)
);
console.log(
  "Imposto Sobre Salario Bruto".padEnd(50, ".") + ": -R$ " + imposto.toFixed(2)
);
console.log(
  "Gratificação".padEnd(50, ".") + ": +R$ " + gratificacao.toFixed(2)
);
console.log(
  "Auxilio Alimentação".padEnd(50, ".") + ": +R$ " + auxAlimentacao.toFixed(2)
);
console.log(
