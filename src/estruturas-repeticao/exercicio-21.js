...
console.log("Total Votos Candidato A".padEnd(50, ".") + ": " + candidatoA + " - " +
    percA.toFixed(2) + "% dos votos válidos.");
console.log("Total Votos Candidato B".padEnd(50, ".") + ": " + candidatoB + " - " +
    percB.toFixed(2) + "% dos votos válidos.");
console.log("Total Votos Candidato C".padEnd(50, ".") + ": " + candidatoC + " - " +
    percC.toFixed(2) + "% dos votos válidos.");
console.log("Total Votos Candidato D".padEnd(50, ".") + ": " + candidatoD + " - " +
    percD.toFixed(2) + "% dos votos válidos.");
console.log("Total Votos Brancos".padEnd(50, ".") + ": " + brancos + " - " +
    percBrancos.toFixed(2) + "% dos votos válidos.");
console.log("Total Votos Nulos".padEnd(50, ".") + ": " + nulos + " - " +
    percNulos.toFixed(2) + "% dos votos válidos.");