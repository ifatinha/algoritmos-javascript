...
do {
    ...
    let preco = scanner.questionFloat("Informe o preco do " + contador + "º produto: ");
    ...
    let categoria = scanner.question("Categoria do Produto (A - Alimentacao; L - Limpeza; V - Vestuario): ");

    while (categoria !== "A" && categoria !== "L" && categoria !== "V") {
        console.log("Opção inválida!");
        categoria = scanner.question("Categoria do Produto (A - Alimentacao; L - Limpeza; V - Vestuario): ");
    }
...
console.clear();
console.log("Média Valores Adicionais".padEnd(50, ".") + ": R$" + mediaValoresAdicionais.toFixed(2));
console.log("Produto com maior preço final".padEnd(50, ".") + ": R$" + maiorPreco.toFixed(2));
console.log("Produto com menor preço final".padEnd(50, ".") + ": R$" + menorPreco.toFixed(2));
console.log("Total Imposto de todos os produtos".padEnd(50, ".") + ": R$" + totalImpostos.toFixed(2));
