...
if (qtdIdade == 0) {
    ...
    console.log("A quantidade de pessoas com idade superior a 50 anos foi de " + qtdIdade + " pessoas.");
}
...
if (qtdAltura === 0) {
    ...
    console.log("A média de altura das pessoas na faixa etária de 10 a 20 anos foi de " + mediaAltura.toFixed(2) + "m.");
}
...
if (percPeso === 0) {
    ...
    console.log("Porcentagem de pessoas com peso abaixo de 40kg: " + percPeso + "%.");
}