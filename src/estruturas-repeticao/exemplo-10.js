...
console.log("Quantidade de jogadores com menos de 18 anos".padEnd(50, ".") + ": " + qtdIdade18);
console.log("Média de altura de todos os jogadores do campeonato".padEnd(50, ".") + ": " + mediaAltura.toFixed(2));
console.log("Percentual de Jogadores com mais de 80kg".padEnd(50, ".") + ": " + percPeso + "%");
