...
do {
  ...
  if (preco > 0) {
    let pais = scanner.questionInt(
      "Pais de Origem (1 - Estados Unidos; 2 - Mexico; 3 - Outros): "
    );
    while (pais !== 1 && pais !== 2 && pais !== 3) {
      pais = scanner.questionInt(
        "Codigo Invalido! Pais de Origem " +
          " (1 - Estados Unidos; 2 - Mexico; 3 - Outros): "
      );
    }

    let meioTransporte = scanner.question(
      "Meio de Transporte (T - Terreste; F - Fluvial; A - Aereo): "
    );
    while (
      meioTransporte !== "T" &&
      meioTransporte !== "F" &&
      ...
      meioTransporte = scanner.question(
        "Opcao invalida! Meio de Transporte " +
    ...
    while (cargaPerigosa !== "S" && cargaPerigosa !== "N") {
      cargaPerigosa = scanner.question(
        "Opcao Invalida! Carga Perigosa (S - Sim; N - Nao): "
      );
    }
    ...
    console.log(
      "Valor Transporte".padEnd(50, ".") + ": R$" + valorTransporte.toFixed(2)
    );
    console.log(
      "Valor Seguro".padEnd(50, ".") + ": R$" + valorSeguro.toFixed(2)
    );
...
console.log(
  "Total Impostos".padEnd(50, ".") + ": R$" + totalImpostos.toFixed(2)
);
