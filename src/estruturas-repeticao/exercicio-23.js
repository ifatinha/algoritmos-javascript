...
do {
  ...
  switch (opcao) {
    case 1:
      ...
      console.log(
        "Novo Sálario".padEnd(50, ".") + ": R$" + novoSalario.toFixed(2)
      );
    ...
    case 2:
      ...
      console.log(
        "1/3 de férias".padEnd(50, ".") + ": R$" + tercoFerias.toFixed(2)
      );
      console.log(
        "Novo Sálario".padEnd(50, ".") + ": R$" + novoSalario.toFixed(2)
      );
    ...
    case 3:
      ...
      let qtdMeses = scanner.questionInt(
        "Quantidade de mêses trabalhados (1 e 12 mêses): "
      );
      while (qtdMeses < 0 || qtdMeses > 12) {
        qtdMeses = scanner.questionInt(
          "Opção inválida! Informe um número entre 1 e 12: "
        );
      }

      let decimo = (salario * qtdMeses) / 12;
      console.log(
        "Valor do 13º sálario".padEnd(50, ".") + ": R$" + decimo.toFixed(2)
      );
