const cursosNames = [
  ...
  "Vigilância em Saúde",
  "Cursos Técnicos em Apoio Educacional",
  "Alimentação Escolar",
  "Biblioteconomia",
  ...
  "Sistemas a Gás",
  "Cursos Técnicos em Gestão e Negócios",
  "Administração",
  "Comércio",
  "Comércio Exterior",
  "Contabilidade",
  ...
  "Cursos Técnicos em Informação e Comunicação",
  "Informática",
  ...
  "Telecomunicações",
  "Cursos Técnicos em Infraestrutura",
  ...
  "Desenho Militar",
  "Eletricidade e Instrumentos Aeronáuticos",
  "Equipamentos de Voo",
  ...
  "Manobras e Equipamentos de Convés",
  "Material Bélico",
  "Mergulho",
  "Operação de Radar",
  "Operação de Sonar",
  "Operações de Engenharia Militar",
  "Preparação Física e Desportiva Militar",
  "Sensores de Aviação",
  "Sinais Navais",
  "Sinalização Náutica",
  "Suprimento",
  ...
  "Rádio e Televisão",
  "Regência",
  "Cursos Técnicos em Produção Industrial",
  "Açúcar e Álcool",
  "Biocombustíveis",
  "Calçados",
  "Celulose e Papel",
