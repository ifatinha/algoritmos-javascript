...
export default class Conta {
  ...
  toString() {
    return (
      ...
      "\n" +
      "Banco:  " +
      Bancos.detalhesBanco(this.banco) +
      ")\n" +
      "Saldo: R$" +
      this.saldo +
      "\n" +
  ...
  cadastrarCheques() {
    for (let i = 0; i < 5; i++) {
      this.talaoCheque.push(
        new Cheque(this.banco.value, this.agencia, this.numero)
      );
    }
  }
  ...
  deposito(valorDeposito) {
    ...
    console.log(
      "Deposito feito com sucesso! " + " Novo saldo: R$" + this.saldo.toFixed(2)
    );
  }
