...
for (let i = 1; i <= 10; i++) {
  ...
  console.log(
    "Valor Hora Trabalhada".padEnd(50, ".") + ": R$ " + valorHoraTrab.toFixed(2)
  );
  console.log(
    "Sálario Bruto".padEnd(50, ".") + ": R$ " + salarioBruto.toFixed(2)
  );
  console.log(
    "Auxilio Alimentação".padEnd(50, ".") +
      ": R$ " +
      auxilioAlimentacao.toFixed(2)
  );
  console.log(
    "Sálario Receber".padEnd(50, ".") + ": R$ " + salarioFinal.toFixed(2)
  );
}
