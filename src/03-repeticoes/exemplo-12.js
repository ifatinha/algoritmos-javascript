...
for (let i = 1; i <= 5; i++) {
  ...
  let numPecas = scanner.questionInt(
    "Digite o total de pecas fabricadas pelo " + i + "º operario: "
  );
  let salario = 0.0;
...
console.log(
  "Total Folha de Pagamento".padEnd(50, ".") + ": R$" + totalFolhaPg.toFixed(2)
);
console.log("Total Peças Produzidas".padEnd(50, ".") + ": R$" + totalPecas);
console.log(
  "Média de Peças Fabricadas por Homens".padEnd(50, ".") +
    ": " +
    mediaHomens.toFixed(2) +
    "%"
);
console.log(
  "Média de Peças Fabricadas por Mulheres".padEnd(50, ".") +
    ": " +
    mediaMulheres.toFixed(2) +
    "%"
);
console.log(
  "Maior Sálario do Mês".padEnd(50, ".") + ": R$" + maiorSalario.toFixed(2)
);
console.log(
  "Matricula do Funcionario com Maior Salario".padEnd(50, ".") +
    ": " +
    matriculaMaiorSal
);
