...
do {
  ...
  if (idade > 0) {
    sexo = scanner.question(
      "Digite o sexo do candidato (m - masculino; f - feminino): "
    );
    while (sexo !== "f" && sexo !== "m") {
      sexo = scanner.question(
        "Opcao invalida! Digite (m - masculino; f - feminino): "
      );
    }

    experiencia = scanner.question(
      "Candidato possui experiencia (s - sim; n - nao): "
    );
    while (experiencia !== "s" && experiencia !== "n") {
      experiencia = scanner.question(
        "Opcao invalida! Digite (s - sim; n - nao): "
      );
    }
...
if (qtdFeminino === 0) {
  ...
  console.log(
    "O número de participantes do sexo feminino foi " + qtdFeminino + "."
  );
  console.log(
    "A menor idade entres as mulheres com experiência foi de " +
      menorIdadeMulherExpe +
      " anos."
  );

  if (qtdMulheres21 === 0) {
    console.log(
      "Não houve nenhuma candidata do sexo feminino com menos 21 anos."
    );
  } else {
    console.log(
      "O número de mulheres com menos de 21 anos com experiência no trabalho foi de " +
        qtdMulheres21 +
        " mulheres."
    );
  }
...
if (qtdMasculino === 0) {
  ...
  console.log(
    "O número de participantes do sexo masculino foi " + qtdMasculino + "."
  );
  ...
  if (qtdExperienciaM === 0) {
    ...
    console.log(
      "A média de idades dos participantes do sexo masculino com experiência foi de " +
        mediaIdadeMasculino +
        " anos."
    );
  }
  ...
  if (qtdHomens45 === 0) {
    ...
    console.log(
      "A porcentagem de homens inscritos com mais de 45 anos foi de " +
        percHomens45 +
        "%."
    );
  }
