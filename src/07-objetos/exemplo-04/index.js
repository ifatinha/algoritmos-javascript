    ...
    switch (opcao) {
      case 1:
        if (imoveis.length < 30) {
          ...
          console.log(
            "O imóvel não foi cadastrado. Você chegou ao número máximo de cadastrados permitido."
          );
        }
        console.clear();
        break;
      ...
      case 3:
        console.clear();
        let index = scanner.questionInt(
          "Digite o indice do imóvel que você deseja alterar: "
        );
      ...
      case 4:
        console.clear();
        console.log(
          "Valor total dos imóveis: R$" +
            gerenciador.totalImoveis(imoveis).toFixed(2)
        );
        break;
      ...
      case 5:
        ...
        console.log(
          "Valor total das comissões: R$" +
            gerenciador.totalComissoes(imoveis).toFixed(2)
        );
        break;
