...
for (let i = 0; i < 10; i++) {
    ...
    console.log("Valor Unitário".padEnd(50, ".") + ": R$" + valorProdutos[i].toFixed(2));
    console.log("Quantidade vendida".padEnd(50, ".") + ": " + qtdVendida[i]);
    console.log("Total Vendido".padEnd(50, ".") + ": R$" + valorVendido.toFixed(2) + "\n");
...
console.log("O valor do produto mais vendido foi de R$" + ValorMaisVendido.toFixed(2) +
    " e ele está na posicão " + posicaoMaisVendido);