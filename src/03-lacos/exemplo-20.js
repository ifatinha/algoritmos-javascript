  ...
  if (matricula !== 99999) {
    ...
    while (sexo !== "M" && sexo !== "F") {
      sexo = scanner.question(
        "Opcao invalida! Sexo (M - Masculino; F - Feminino): "
      );
    }

    let qtdHorasAula = scanner.questionInt(
      "Quantidade Horas Trabalhadas Mensalmente: "
    );
...
if (qtdHomens > 0) {
  ...
  console.log(
    "Média Salarial Professores do Sexo Masculino".padEnd(50, ".") +
      ": R$" +
      mediaSalH.toFixed(2)
  );
} else {
...
if (qtdMulheres > 0) {
  ...
  console.log(
    "Média Salarial Professores do Sexo Feminino".padEnd(50, ".") +
      ": R$" +
      mediaSalM.toFixed(2)
  );
} else {
