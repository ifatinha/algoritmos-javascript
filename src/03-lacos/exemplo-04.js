...
for (let i = 1; i <= 5; i++) {
  ...
  let acidentesComVitimas = scanner.questionInt(
    "Quantidade de acidentes com vitimas: "
  );
...
console.log(
  "A cidade com maior indice de acidentes com vitimas foi a cidade " +
    cidadeMaiorIndice +
    " com " +
    maiorIndice +
    " acidentes."
...
console.log(
  "A cidade com menor indice de acidentes com vitimas foi a cidade " +
    cidadeMenorIndice +
    " com " +
    menorIndice +
    " acidentes."
...
console.log(
  "TOTAL ACIDENTES NAS CIDADES COM MENOS DE 2000 HABITANTES: " + totalAcidentes
);
console.log(
  "MEDIA ACIDENTES NAS CIDADES COM MENOS DE 2000 HABITANTES: " +
    mediaAcidentes.toFixed(2)
);
