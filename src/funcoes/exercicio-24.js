...
function mesPorExtenso(mes) {
    const mesesExtenso = ["Janeiro", "Fevereiro", "Março", "Abril", "Maio", "Junho", "Julho", "Agosto", "Setembro",
...
function lerDados() {
    for (let i = 0; i < 12; i++) {
        temperaturas.push(scanner.questionInt("Quantos graus fez em " + mesPorExtenso(i) + ": "));
    }
}
...
function maiorTemperatura(temperaturas) {
    ...
    return "O mês mais quente do ano foi " + mesPorExtenso(mes) + " com temperatura de " + maior + "ºC";
}
...
function menorTemperatura(temperaturas) {
    ...
    return "O mês mais frio do ano foi " + mesPorExtenso(mes) + " com temperatura de " + menor + "ºC";
}
