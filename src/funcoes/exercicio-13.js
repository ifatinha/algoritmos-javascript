  ...
  for (let i = 1; i <= 15; i++) {
    ...
    while (
      ...
      sexo = scanner.question(
        "Sexo Inválido! Sexo (m - masculino; f - feminino; o - outros): "
      );
    }
    sexos.push(sexo);
...
console.log(
  "A quantidade de mulheres que tem três filhos e quem recebem até R$ 2000.00 foi de " +
    qtd +
    " mulheres."
);
