...
let cadeia = scanner.question("Digite a cadeia que voce quer pesquisar na sequencia: ");

while (cadeia.length > texto.length) {
    cadeia = scanner.question("Erro! Tamanho incorreto. Digite outra subcadeia: ");
}
...
if (aparicoes === null) {
    ...
    console.log("A cadeia " + cadeia + " aparece " + aparicoes.length + " na sequencia informada.");
}