...
function cadastrarProduto() {
  ...
  if (!jaExiste) {
    console.log(
      "Foi cadastrado um produto com os dados abaixo:\n" + produto.toString()
    );
    produtos.push(produto);
  } else {
    console.log(
      "Erro! Já existe um produto cadastrado com o codigo informado."
    );
  }
}
...
function removerProduto() {
  ...
  if (index !== -1) {
    console.log(
      "O produto abaixo foi removido do estoque\n" + produtos[index].toString()
    );
