  ...
  do {
    ...
    switch (opcao) {
      case 1:
        ...
        console.log(
          "Foi criada uma conta simples com os seguintes dados\n" +
            conta.toString()
        );
        contas.push(conta);
        break;
      ...
      case 2:
        ...
        conta = novaConta(opcao);
        console.log(
          "Foi criada uma conta corrente com os seguintes dados\n" +
            conta.toString()
        );
        contas.push(conta);
        break;
      ...
      case 3:
        ...
        conta = novaConta(opcao);
        console.log(
          "Foi criada uma conta poupança com os seguintes dados\n" +
            conta.toString()
        );
        contas.push(conta);
        break;
