...
let perceDistribuidor = parseFloat(
  scanner.question("Percentual de lucro do distribuidor: ")
);
...
console.log(
  "Preço de Fábrica".padEnd(50, ".") + ": " + precoFabrica.toFixed(2) + ",00R$"
);
console.log(
  "Imposto Distribuidor".padEnd(50, ".") +
    ": " +
    lucroDistribuidor.toFixed(2) +
    ",00R$"
);
console.log("Impostos".padEnd(50, ".") + ": " + imposto.toFixed(2) + ",00R$");
console.log(
  "Preço de Final".padEnd(50, ".") + ": " + precoFinal.toFixed(2) + ",00R$"
);
