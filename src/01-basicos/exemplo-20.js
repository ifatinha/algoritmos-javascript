...
console.log(
  "Salario Minimo".padEnd(50, ".") + ": " + salarioMinino.toFixed(2) + "R$"
);
console.log(
  "Valor da hora trabalhada".padEnd(50, ".") +
    ": " +
    valorHoraTrabalhada.toFixed(2) +
    "R$"
);
console.log("Horas Trabalhadas".padEnd(50, ".") + ": " + horasTrabalhadas);
console.log(
  "Salario Bruto".padEnd(50, ".") + ": " + salarioBruto.toFixed(2) + "R$"
);
console.log("Valor do imposto".padEnd(50, ".") + ": " + imposto + "%");
console.log(
  "Salario á Receber".padEnd(50, ".") + ": " + salarioReceber.toFixed(2) + "R$"
);
