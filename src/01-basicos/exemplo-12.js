...
console.log("Valor depositado".padEnd(50, ".") + ": " + deposito.toFixed(2) + ",00R$");
console.log("Valor rendimento".padEnd(50, ".") + ": " + valorRendimento.toFixed(2) + ",00R$");
console.log("Valor Total".padEnd(50, ".") + ": " + valorTotal.toFixed(2) + ",00R$");