...
if (codProduto > 0 && codProduto <= 10) {
    ...
    if (codPais > 0 && codPais <= 3) {
        ...
        if (codProduto === 1 || codProduto === 2 || codProduto === 3 || codProduto === 4) {
            valorGrama = 10.00;
        ...
        console.log("Peso em Kg: ".padEnd(50, ".") + ": " + pesoProduto + " quilos");
        console.log("Peso em Gramas: ".padEnd(50, ".") + ": " + pesoGrama + " gramas");
        ...
        console.log("Valor Total do Produto: ".padEnd(50, ".") + ": R$ " + valorTotal);
    } else {
