...
if (d < a) {
  console.log(
    "A ordem decrescente dos números é: " + c + ", " + b + ", " + a + ", " + d
  );
} else if (d < b) {
  console.log(
    "A ordem decrescente dos números é: " + c + ", " + b + ", " + d + ", " + a
  );
} else if (d < c) {
  console.log(
    "A ordem decrescente dos números é: " + c + ", " + d + ", " + b + ", " + a
  );
} else {
  console.log(
    "A ordem decrescente dos números é: " + d + ", " + c + ", " + b + ", " + a
  );
}
