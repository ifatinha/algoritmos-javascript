...
let salarioBase = scanner.questionFloat("Informe o salario base do funcionario: ");
let tempoServico = scanner.questionInt("Informe o tempo de trabalho do funcionario: ");
...
console.log("Tempo de Serviço: ".padEnd(50, ".") + ": " + tempoServico + " ano(s)");
