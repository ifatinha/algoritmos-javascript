class Funcionario {
    ...
    toString() {
        return "\nDados do funcionário: \n" +
            "Código do Cargo: " + this.office.code + "\n" +
            "Valor da Hora Trabalhada: " + this.office.hourlyRate + "\n" +
            "Sexo: " + this.sex + "\n" +
            "Quantidade de horas trabalhada: " + this.quantityHoursWorked + "\n" +
            "Sálario Final: R$" + this.calculateFinalSalary().toFixed(2);
    }
}
