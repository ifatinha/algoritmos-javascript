...
console.log("Custo total da peça".padEnd(50, ".") + ": " + custoTotal.toFixed(2) + "R$");
console.log("Valor do ingresso".padEnd(50, ".") + ": " + precoEntrada.toFixed(2) + "R$");
console.log("Quantidade de ingressos que devem ser vendidos".padEnd(50, ".") + ": " +
