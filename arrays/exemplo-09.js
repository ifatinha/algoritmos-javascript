...
const origem = ["Rio Branco", "Goiania", "Curitiba", "Porto Alegra", "Palmas", "Florianópolis", "Belém",
    "Campo Grande", "Vitória", "Brasilia"];
const destino = ["São Paulo", "São Luís", "João Pessoa", "Macéio", "Aracajú", "Rio de Janeiro", "Salvador",
    "Teresina", "Recife", "Porto Velho"];
            ...
            do {
                ...
                switch (opcao) {
                    case 1:
                        ...
                        console.log("Aguarde! Estamos procurando dados sobre o voo de numero " + numero);
                        ...
                        if (indice !== -1) {
                            ...
                            console.log("Não foi encontrado nenhum voo com o número informado.");
                        }
                    ...
                    case 2:
                        ...
                        console.log("Aguarde! Estamos procurando dados sobre o voo que saem de " + nomeOrigem);
                        ...
                        if (indice !== -1) {
                            ...
                            console.log("Não foi encontrado nenhum voo com origem em " + nomeOrigem + ".");
                        }
                    ...
                    case 3:
                        ...
                        console.log("Aguarde! Estamos procurando dados sobre o voo que chegam em " + nomeDestino);
                        ...
                        if (indice !== -1) {
                            ...
                            console.log("Não foi encontrado nenhum voo com destino " + nomeDestino + ".");
                        }
